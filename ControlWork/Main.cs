...
{    
    ...
    {        
        ...
        {           
            InitializeComponent();
            sqlConnection1.ConnectionString = $"Data Source=.\\SQLEXPRESS;Initial Catalog=ApressFinancial;Persist Security Info=True;User ID={Data.login};Password={Data.password}";
